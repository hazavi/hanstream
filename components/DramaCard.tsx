        ...
        <div className="relative overflow-hidden rounded-xl sm:rounded-2xl glass-card card-hover">
          <div className="relative aspect-[4/5] overflow-hidden">
            ...
            <div className="absolute top-2 left-2 sm:top-3 sm:left-3 flex gap-1 sm:gap-2">
              ...
              <span className={`px-1.5 py-0.5 sm:px-2 sm:py-1 text-[10px] sm:text-xs font-semibold rounded-md sm:rounded-lg ${
                d.type === 'SUB' 
          ...
          <div className="p-2 sm:p-3 md:p-4 space-y-1 sm:space-y-2">
            <h3 className="text-xs sm:text-sm font-semibold leading-tight line-clamp-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
              {d.title}
            </h3>
            <div className="flex items-center gap-1.5 sm:gap-2">
              <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-green-500"></div>
              <p className="text-[10px] sm:text-xs text-gray-600 dark:text-gray-400">{formatRelativeTime(d.time)}</p>
            </div>
          </div>
        </div>
      </Link>
